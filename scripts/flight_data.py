...
def generate_dataset(output_file, rows):
    with open(output_file, "w") as fd:
        fieldnames = ["airline", "from" , "to", "day", "month", "year", "age", "gender", "reason", "stay", "transit", "connection", "wait","departure"]
        ...
        for i in range(rows):
            ...
            if reason == "Back Home":
                ...
                wait = 0
                transit = choice(transits)
            #Added line for knowing if the passengers will be at the airport before a main eating hour
            departure = randrange(2, 20)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output",
            help="Specify the output filename of your csv, defaults to: flight_passengers.csv", default="assets/flight_passengers.csv")
